# https://devportal.intuit.com/app/dp/capability/CAP-2297/capabilityDocs/main/docs/concepts/client-lib.md
# https://github.intuit.com/nocode-execution/genosclient/blob/master/examples.ipynb
